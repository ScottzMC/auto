...
<html>
	<head>
		...
		<title>Register || Auto Club</title>
        ...
        <div class="row">
          ...
          <div class="col-lg-9 col-md-8 col-sm-7 col-xs-6">
            <div class="b-submit__main">
              ...
              <form action="<?php echo base_url('account/register'); ?>" method="POST" enctype="multipart/form-data" class="s-submit clearfix">
                <div class="row">
                  <div class="col-md-6 col-xs-12">
                    ...
                    <div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
                      ...
                      <input placeholder="Enter SurName" type="text" name="surname" />
                ...
                <button type="submit" name="register" class="btn m-btn pull-right wow zoomInUp" data-wow-delay="0.5s">Create Account<span class="fa fa-angle-right"></span></button>
              </form>
