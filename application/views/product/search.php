...
<html>
    ...
    <!--<g?php foreach($query as $row){} ?>-->
    <title><?php echo str_replace('-', ' ', $_POST['search_query']); ?> || Your Engine Parts || No 1 Nigeria Industrial Spare Parts</title>
    ...
    <div class="b-breadCumbs s-shadow">
        <div class="container wow zoomInUp" data-wow-delay="0.5s">
            <a href="<?php echo site_url('home'); ?>" class="b-breadCumbs__page">Home</a><span class="fa fa-angle-right"></span>
						<a href="#" class="b-breadCumbs__page m-active">All <?php echo $_POST['search_query']; ?> Listing Results</a>
        </div>
    </div><!--b-breadCumbs-->
        ...
        <div class="container">
         ...
         <?php
          ...
          <div class="col-lg-9 col-sm-8 col-xs-12">
                  ...
                  <img class="img-responsive" src="<?php echo base_url('uploads/product/'.$image); ?>" alt="<?php echo $row->title; ?>"/>
									<span class="b-items__cars-one-img-type m-premium"><?php echo $row->status; ?></span>
								</div>
								<div class="b-items__cars-one-info">
									<header class="b-items__cars-one-info-header s-lineDownLeft">
										<h2><?php echo str_replace('-', ' ', $row->title); ?></h2>
									...
									<div class="b-items__cars-one-info-details">
										<div class="b-featured__item-links">
											<a href="<?php echo site_url('product/detail/'.$row->type); ?>"><?php echo $row->type; ?></a><span class="fa fa-angle-right"></span>
											<a href="#"><?php echo $row->category; ?></a><span class="fa fa-angle-right"></span>
											<a href="#"><?php echo $row->subcategory; ?></a>
										</div>
										<a href="<?php echo site_url('product/detail/'.$row->type.'/'.$row->title); ?>" class="btn m-btn">VIEW DETAILS<span class="fa fa-angle-right"></span></a>
									</div>
								</div>
							</div>
            <?php } }else{
              echo '<div class="alert alert-danger" role="alert">No Search Result</div>';
            } ?>
						<br><br>
						</div>
					</div>
