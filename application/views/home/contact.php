...
<html>
	<head>
		...
		<title>Contact Us || Your Engine Parts || No 1 Nigeria Industrial Spare Parts</title>
    ...
    <header class="b-topBar wow slideInDown" data-wow-delay="0.7s">
						...
						<div class="b-nav__list wow slideInRight" data-wow-delay="0.3s">
							...
							<div class="collapse navbar-collapse navbar-main-slide" id="nav">
								<ul class="navbar-nav-menu">
									<?php foreach($type as $drow){ ?>
										<li><a href="<?php echo site_url('product/type/'.$drow->type); ?>"><?php echo $drow->type; ?></a></li>
									<?php } ?>
		...
		<div class="b-breadCumbs s-shadow wow zoomInUp" data-wow-delay="0.5s">
			<div class="container">
				...
				<a href="<?php echo site_url('contact'); ?>" class="b-breadCumbs__page m-active">Contact Us</a>
			</div>
		</div><!--b-breadCumbs-->
				...
				<div class="row">
					<div class="col-xs-6">
						<div class="b-contacts__form">
							...
							<form action="<?php echo base_url('contact'); ?>" method="POST" novalidate class="s-form wow zoomInUp" data-wow-delay="0.5s">
								<input type="text" style="text-transform: none;" placeholder="YOUR NAME" name="fullname" value="<?php echo set_value('fullname'); ?>" />
								<span class="text-danger"><?php echo form_error('fullname'); ?></span>
								<input type="text" style="text-transform: none;" placeholder="EMAIL ADDRESS %" name="email" value="<?php echo set_value('email'); ?>" />
								<span class="text-danger"><?php echo form_error('email'); ?></span>
								<input type="text" style="text-transform: none;" placeholder="PHONE NO." name="telephone" value="<?php echo set_value('telephone'); ?>" />
								<span class="text-danger"><?php echo form_error('telephone'); ?></span>
								<input type="text" style="text-transform: none;" placeholder="MESSAGE TITLE." name="title" value="<?php echo set_value('title'); ?>" />
								<span class="text-danger"><?php echo form_error('title'); ?></span>
								<textarea style="text-transform: none;" name="message" placeholder="COMMENT/SUGGESTIONS/FEEDBACK"></textarea>
